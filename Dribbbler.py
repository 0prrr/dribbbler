...
def openurl(url):
    ...
    req.add_header('User-Agent', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36')
...
def get_dribble_pics(keyword, folder='dribbble', pages=10):
    ...
    for page_num in range(pages):
        ...
        dribble_page_url = 'https://dribbble.com/search?q='+ search_query + '&page=' + str(page_num + 1)
